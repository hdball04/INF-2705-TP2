...
public:
    ...
    MatricePipeline obtenirMatriceCourante( )
    {
        ...
        mtc.Translate(rayon, hauteur, 0.0); // se déplacer dans la direction de l'axe des X ainsi tourner

        // Utiliser ou non la rotation geosynchrone
        if (Etat::orbiteGeosynchrone) mtc.Rotate(angle*4, 0, 1, 0);
